...
public class UserDaoSendCodeByAlidayu_PhoneImp extends HibernateTemplate  {
	private AuthCodeEntity entity;
	
	public UserDaoSendCodeByAlidayu_PhoneImp(AuthCodeEntity entity) {
		super();
		this.entity = entity;
	}
	...
	protected Session handle(Session session) {
		...
		//若不存在则发送短信
		if(count==0){
			SMS.sendMsg(entity.getCode(), entity.getPhone());
		}
